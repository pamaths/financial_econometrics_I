...
\subsubsection{Adequation of Normal Distribution for Standardized Residuals}
...
The tests results are presented in Table \ref{tbl:dgt_normality}. First considering uniformity I reject the null hypothesis

Further more for autocorrelations we see that ... 
...
Overall, the DGT test results for validity of normal distribution for standardized innovations in the GARCH(1,1) model is rejected. Thus, next we consider other possible non-normal distributions.
